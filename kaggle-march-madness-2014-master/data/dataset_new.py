# -*- coding: utf-8 -*-
"""
Created on Thu Nov 26 13:47:03 2015
...
# directories
#HOME= expanduser("~")
DATA ='F:/Grad Projects/March Mania/kaggle-march-madness-2014-master/data/'

# input files
TEAMS = DATA + 'teams.csv'
TOURNEY_RESULTS = 'tourney_results.csv'
REG_RESULTS = 'regular_season_results.csv'
SLOTS = 'tourney_slots.csv'
SEEDS = 'tourney_seeds.csv'
SEASONS ='seasons.csv'
RANKINGS = 'ordinal_ranks_core_33.csv'
TEST_SEASON = 'test_season.csv'
